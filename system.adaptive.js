...
const adaptiveSystem = {
    ...
    init: function () {
        ...
        if (Memory.adaptive.currentMode === undefined) {
            Memory.adaptive.currentMode = this.MODE.NORMAL;
        }
        if (Memory.adaptive.lastCheck === undefined) {
            Memory.adaptive.lastCheck = 0;
        }
        if (!Memory.adaptive.modeHistory) {
            Memory.adaptive.modeHistory = [];
        }
        if (!Memory.adaptive.stats) {
            Memory.adaptive.stats = {
                emergencyCount: 0,
                minimalCount: 0,
                normalCount: 0,
                fullCount: 0,
            ...
            if (Memory.adaptive.stats.emergencyCount === undefined) Memory.adaptive.stats.emergencyCount = 0;
            if (Memory.adaptive.stats.minimalCount === undefined) Memory.adaptive.stats.minimalCount = 0;
            if (Memory.adaptive.stats.normalCount === undefined) Memory.adaptive.stats.normalCount = 0;
            if (Memory.adaptive.stats.fullCount === undefined) Memory.adaptive.stats.fullCount = 0;
        }
    },
