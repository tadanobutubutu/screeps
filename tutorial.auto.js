...
const autoTutorial = {
     ...
     */
    autoStep: function () {
        const caches = this.prepopulateCaches();
        this.autoStepCreeps(caches);
        this.autoStepTowers(caches);
        this.autoStepSpawn();
    },

    prepopulateCaches: function () {
    ...
    autoStepCreeps: function (caches) {
    ...
    autoStepTowers: function (caches) {
