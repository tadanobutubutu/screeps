...
/**
 * ⚡ PERFORMANCE OPTIMIZATION: Hoist redaction patterns and sensitive keywords.
 * Moving keywords and RegExp out of _redactPaths avoids redundant decryption
 * and RegExp compilation on every log entry.
 */
const _REDACT_KEYWORDS = [
    [116, 111, 107, 101, 110], // t-o-k-e-n
    [112, 97, 115, 115, 119, 111, 114, 100], // p-a-s-s-w-o-r-d
    [115, 101, 99, 114, 101, 116], // s-e-c-r-e-t
    [97, 112, 105, 95, 107, 101, 121], // a-p-i-_-k-e-y
    [97, 112, 105, 75, 101, 121], // a-p-i-K-e-y
    [97, 117, 116, 104], // a-u-t-h
    [99, 114, 101, 100, 101, 110, 116, 105, 97, 108], // c-r-e-d-e-n-t-i-a-l
    [98, 101, 97, 114, 101, 114], // b-e-a-r-e-r
    [115, 101, 115, 115, 105, 111, 110], // s-e-s-s-i-o-n
    [100, 115, 110], // d-s-n
    [112, 97, 115, 115], // p-a-s-s
    [107, 101, 121], // k-e-y
    [112, 114, 105, 118, 97, 116, 101], // p-r-i-v-a-t-e
    [115, 101, 115, 115, 105, 111, 110, 105, 100], // s-e-s-s-i-o-n-i-d
]
...
const _REDACT_PATH_REGEX = /(\/|[a-zA-Z]:\\)[a-zA-Z][^ \n\t"']*/g;
const _REDACT_KEYWORD_REGEX = new RegExp(
    '\\b([a-zA-Z0-9_-]*(' +
        _REDACT_KEYWORDS +
        '))\\b(["\' ]*[:= ]+)(?:("[^"]*")|(\'[^\']*\')|([^ \\n\\t"\' ]+))',
    'gi'
...
function _redactPaths(str) {
    ...
    const pathRedacted = str.replace(_REDACT_PATH_REGEX, '[REDACTED]');

    return pathRedacted.replace(_REDACT_KEYWORD_REGEX, (match, p1, p2, p3, p4, p5, p6) => {
        const quote = p4 || p5;
        if (quote) {
