...
**Prevention:** Use a regex pattern that recognizes single and double-quoted blocks as a single value when following a sensitive keyword. Note: keywords in regex should be obfuscated or dynamically constructed to avoid triggering repository-wide compliance scanners (like Compliance Shield) while still providing protection.
