...
/**
 * 各モードで有効な機能を定義 (Hoisted to avoid per-call allocation)
 */
const FEATURES = {
    // EMERGENCY: 最小限
    [MODES.EMERGENCY]: {
...
const adaptiveSystem = {
    ...
    isEnabled: function (feature) {
        // Hoisted check for better performance in high-frequency calls
        const mode = Memory.adaptive ? Memory.adaptive.currentMode : this.MODE.NORMAL;
