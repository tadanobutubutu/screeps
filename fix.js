...
content = content.replace(/const hostiles = room\.find\(FIND_HOSTILE_CREEPS\);/g, 'const hostiles = cache.getEnemies(room);');
...
testContent = testContent.replace(/global\.STRUCTURE_RAMPART = 'rampart';/, `global.STRUCTURE_RAMPART = 'rampart';
