...
jest.mock('../src/constants', () => ({
  PATHFINDER_DEFAULTS: { ROAD_COST: 1, MAX_ROOMS: 2, PLAIN_COST: 2, SWAMP_COST: 10, REUSE_PATH: 5 },
  CACHE_TTL: { PATH: 3 },
}), { virtual: true });
    ...
    const room = {
      find: jest.fn()
        .mockReturnValueOnce([
          ...
          { structureType: global.STRUCTURE_RAMPART, pos: { x: 3, y: 3 }, my: false, isPublic: false },
        ])
