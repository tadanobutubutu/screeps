...
// ⚡ PERFORMANCE: Hoisted feature configuration to prevent per-call allocation
// BOLT: Moving this outside of isEnabled() saves CPU by avoiding object creation every tick.
const FEATURES = {
    [MODES.EMERGENCY]: {
        basicRoles: true,
        spawn: true,
