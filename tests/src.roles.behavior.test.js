    ...
    describe('defender', () => {
        test('敵がいるとき攻撃し回復する', () => {
            ...
            const creep = {
                room: roomMock,
                name: 'def1',
                getActiveBodyparts: jest.fn((part) => (part === RANGED_ATTACK || part === ATTACK || part === HEAL ? 1 : 0)),
    ...
    describe('miner', () => {
        test('コンテナがある場合は移動して採掘する', () => {
            ...
            const creep = {
                ...
                memory: {},
                room,
                pos: { isEqualTo: jest.fn().mockReturnValue(false), getRangeTo: () => 1 },
        ...
        test('コンテナなしで満杯時にドロップする', () => {
            ...
            const creep = {
                ...
                memory: {},
                room,
                pos: { isEqualTo: jest.fn().mockReturnValue(true), getRangeTo: () => 1 },
