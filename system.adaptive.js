...
// ⚡ PERFORMANCE: Hoist constants to reduce per-tick allocations
const MODES = {
    EMERGENCY: 0,
    MINIMAL: 1,
    NORMAL: 2,
...
// ⚡ PERFORMANCE: Extract features map to avoid per-call object creation in isEnabled
const FEATURES = {
    // EMERGENCY: 最小限
    [MODES.EMERGENCY]: {
        basicRoles: true,
...
const adaptiveSystem = {
    ...
    isEnabled: function (feature) {
        ...
        // ⚡ PERFORMANCE: Use hoisted FEATURES map instead of creating it every call
