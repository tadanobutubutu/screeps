...
/**
 * 各モードで有効な機能の定義 (Hoisted to prevent per-tick allocation)
 */
const FEATURES = {
    // EMERGENCY: 最小限
    [MODES.EMERGENCY]: {
...
const adaptiveSystem = {
    ...
    isEnabled: function (feature) {
        ...
        // Use hoisted FEATURES map to avoid per-call allocations
        const modeFeatures = FEATURES[mode];
        return modeFeatures && modeFeatures[feature] === true;
    },
