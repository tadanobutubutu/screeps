...
- 🚀 **毎15分**: ゲーム監視・エラー検出
- ⚡ **毎30分**: AIエラー修正
- 🔄 **毎2時間**: Core Development Bots
- 🔧 **毎3時間**: Maintenance Bots
- 📅 **毎日**: システムメンテナンス
...
14. QA_REPORT.md
15. WORKFLOW_HEALTH.md
16. GAME_STATUS.md
17. CONSOLE_LOGS.md
18. DETECTED_ERRORS.json
19. USAGE_REPORT.md
20. ERROR_STATS.md
...
2. ユニークな`user.name`と`user.email`を設定
3. 適切な頻度でスケジュール
4. このファイルを更新
...
GitHubのContributorsページで全Botの活動を確認できます！
